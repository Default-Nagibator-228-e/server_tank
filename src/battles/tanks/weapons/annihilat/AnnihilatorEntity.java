...
public class AnnihilatorEntity implements IEntity {
   ...
   public AnnihilatorEntity(float shotRange, float shotSpeed, float shotRadius, float damage_min, float damage_max, float frezeeSpeed, ShotData shotData) {
