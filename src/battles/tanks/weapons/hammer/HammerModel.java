...
public class HammerModel extends FireableWeaponAnticheatModel implements IWeapon {
   private BattlefieldModel bfModel;
   private BattlefieldPlayerController player;
   private WeaponWeakeningData weakeingData;
   private HammerEntity entity;

   public HammerModel(HammerEntity hammerEntity, WeaponWeakeningData weakeingData, BattlefieldPlayerController tank, BattlefieldModel battle) {
      super(hammerEntity.getShotData().reloadMsec);
      this.bfModel = battle;
      this.player = tank;
      this.entity = hammerEntity;
