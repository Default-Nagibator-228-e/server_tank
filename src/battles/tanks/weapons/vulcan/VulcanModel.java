package battles.tanks.weapons.vulcan;
...
public class VulcanModel extends FireableWeaponAnticheatModel implements IWeapon {
   ...
   public VulcanModel(VulcanEntity vulcanEntity, WeaponWeakeningData weakeingData, BattlefieldPlayerController tank, BattlefieldModel battle) {
      super(vulcanEntity.getShotData().reloadMsec);
      this.bfModel = battle;
      this.player = tank;
      this.entity = vulcanEntity;
