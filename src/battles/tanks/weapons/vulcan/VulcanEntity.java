...
public class VulcanEntity implements IEntity {
   ...
   public VulcanEntity(float shotRange, float shotSpeed, float shotRadius, float damage_min, float damage_max, float frezeeSpeed, ShotData shotData) {
